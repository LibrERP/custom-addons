...
#. Clone the branch 12.0 of the repository https://github.com/LibrERP/custom-addons
#. Add the path to this repository in your configuration (addons-path)
#. Update the module list
#. Search for "Partner Data from VIES" in your addons
#. install the module
