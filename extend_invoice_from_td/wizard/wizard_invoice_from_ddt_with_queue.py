...
class WizardInvoiceFromDdt(models.TransientModel):
    ...
    def create_invoice(self):
        ...
        for ddt_group in ddt_groups_list:
            ...
            ddts_recordset.with_context(invoice_creation_context).with_delay().action_invoice_create()  # abilitare questa riga e disabilitare la successiva per abilitare fatturazione in multiprocessing
            # ddts_recordset.with_context(invoice_creation_context).action_invoice_create()
